...
function (angular, app, _, $, kbn) {
  ...
  var module = angular.module('kibana.panels.topvisits', []);
  app.useModule(module);

  module.controller('topvisits', [ '$scope', 'querySrv', 'dashboard', 'filterSrv', 'fields', function($scope, querySrv, dashboard, filterSrv, fields) {
    $scope.panelMeta = {
      modals : [
        {
          description: "Inspect",
  ...
  module.directive('termsChart', [ 'querySrv', function(querySrv) {
    return {
      restrict: 'A',
