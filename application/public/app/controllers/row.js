define(['angular', 'app', 'lodash'], function(angular, app, _) {'use strict';

	var module = angular.module('go4smac.controllers');

	module.controller('RowCtrl', ['$scope', '$rootScope', '$timeout',
	function($scope, $rootScope, $timeout) {
		...
		$scope.reset_panel = function(type) {
			var defaultSpan = 4, _as = 12 - $scope.rowSpan($scope.row);
