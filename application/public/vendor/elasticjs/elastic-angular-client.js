  ...
  return function (config) {
    ...
    ejs.client = {
      ...
      post: function (path, data, successcb, errorcb) {
        ...
        var reqConfig = {url: path, data: data, method: 'POST', withCredentials : true};
      ...
      get: function (path, data, successcb, errorcb) {
        ...
        var reqConfig = {url: path, params: data, method: 'GET', withCredentials : true};
        return promiseThen($http(angular.extend(reqConfig, config)), successcb, errorcb);
      },
      put: function (path, data, successcb, errorcb) {
        path = config.server + path;
        var reqConfig = {url: path, data: data, method: 'PUT', withCredentials : true};
        return promiseThen($http(angular.extend(reqConfig, config)), successcb, errorcb);
      },
      del: function (path, data, successcb, errorcb) {
        path = config.server + path;
        var reqConfig = {url: path, data: data, method: 'DELETE', withCredentials : true};
        return promiseThen($http(angular.extend(reqConfig, config)), successcb, errorcb);
      },
      head: function (path, data, successcb, errorcb) {
        path = config.server + path;
        // no body on HEAD request, data will be request params
        var reqConfig = {url: path, params: data, method: 'HEAD', withCredentials : true};
